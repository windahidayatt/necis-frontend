                                    ...
                                    <div class="product_count mt-3">
                                        ...
                                        <div class="mb-5">
                                            <div class="input-group mb-3" style={{maxWidth: "200px"}}>
                                                ...
                                                <button class="btn btn-primary js-btn-minus" type="button">&minus;</button>
                                                </div>
                                                ...
                                                <div class="input-group-append">
                                                    <button class="btn btn-primary js-btn-plus" type="button">&plus;</button>
                                                </div>
                                            </div>
